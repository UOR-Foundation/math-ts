...
import { ArtifactBasedFactorization } from '@uor-foundation/resonance';
...
async function testArtifactFactorization() {
  ...
  const artifactFactorizer = new ArtifactBasedFactorization(substrate);
  const multiModalFactorizer = new MultiModalFactorization(substrate);
