...
const field_prime_detection_1 = require("@uor-foundation/resonance/src/field-prime-detection");
...
for (const n of testNumbers) {
    const analysis = (0, field_prime_detection_1.analyzeFieldDynamics)(substrate, n);
    const correct = knownPrimes.includes(n);
...
for (let n = 2n; n <= 50n; n++) {
    const isPrime = (0, field_prime_detection_1.isPrimeViaFieldDynamics)(substrate, n);
